 ...
 */
export function getE2ETestUser(): TestUser {
 ...
 */
export async function createTestUser(page: Page, user?: TestUser): Promise<TestUser> {
 ...
 */
export async function loginTestUser(page: Page, user: TestUser, redirectTo?: string): Promise<void> {
 ...
 */
export async function setupAuthState(page: Page, authToken: string): Promise<void> {
 ...
 */
export async function quickLogin(page: Page, user?: TestUser): Promise<TestUser> {
  // Use the dedicated E2E test user by default (already exists in test DB)
  const testUser = user || getE2ETestUser();
 ...
 */
export async function quickLoginAsE2EUser(page: Page): Promise<TestUser> {
  return quickLogin(page, getE2ETestUser());
}

// Export an AuthHelper namespace for backward compatibility
